...
<body>
    ...
    <div class="mainbody">
        ...
        <div class="card">
            ...
            <p>Advanced technologies have the power to transform the way we do business and the value we can offer
                clients. These tools also have a lot to teach us about the way we can tackle challenges across all
                business functions. In the Algorithmic Business Thinking Sprint (ABTS) a new on-demand, asynchronous
                learning experience from MIT Sloan Executive Education, Faculty Director Paul McDonagh-Smith introduces
                the concept of Algorithmic Business Thinking—a framework for understanding the key principles of
                algorithms, code, and data and a methodology for applying those principles across role and departments,
                from products and service to business functions like finance, sales, and marketing. The ABT framework
                marks a radical rethinking of how technology, people, and processes combine to create and deliver value.
                Inspired by Agile product development sprints, this self-directed course is an opportunity to apply this
                cutting-edge concept directly to a challenge you are facing in your own organization. You'll engage in
                four core components of the sprint cycle—goal setting, relays, review, and retrospective—and use them to
                understand and apply the cornerstones of computer science as a transformational problem-solving
                technique. The reading materials, videos by faculty and industry experts, podcasts, and sprint workbook
                supplied will walk you through each of these cornerstones—decomposition, pattern recognition,
                abstraction and algorithms—enabling you to you crack the code on your business challenge in record time.
            </p>
            <hr>
            <!-- Week 1 Section -->
            <div class="week-section" id="week1">
                <div class="cardinside">
                    ...
                    <div class="cardtext">
                        <p class="heading">Algorithmic Business Thinking</p>
                        <div class="cardtext2">
                            <p>Explore the challenges and opportunities </p>
            ...
            <div class="week-section" id="week5">
                ...
                <div style="display: flex;">
                    <button class="btn btn-warning btn-quiz" style="height: min-content;"
                        onclick="openQuizModalWeek5()">Quiz</button>
                    <form action="grading" onsubmit="openPopup(event)" style="margin-left:45%;">
                        <button type="submit" style="margin-top: 1.15rem;" class="btn btn-success"
                            onclick="openPopup()">Submit for Grading</button>
                        <p>${errorsubmit}</p>
                    </form>
                </div>
