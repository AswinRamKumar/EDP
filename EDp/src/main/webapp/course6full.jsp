...
<body>
    ...
    <div class="mainbody">
        ...
        <div class="card">
            ...
            <p>The ability to navigate rapid, unpredictable, and exponential change is crucial for success. But
                embracing the unexpected is more than just a survival strategy—it's a conduit to innovation and growth.
                This course offers a transformative learning experience that empowers individuals and organizations to
                harness creative solutions to significant challenges in the face of uncertainty. Guided by MIT Sloan
                innovation expert Hal Gregersen and Pixar co-founder Ed Catmull, this unique new course leverages
                insight from their research interviews and diverse case studies to explore the leadership mindset and
                system level actions required to tackle large scale challenges and catalyze a believable framework for
                the future—a future state that cannot be realized without years of sustained effort so that compounding
                growth occurs across an entire ecosystem. Through a combination of theoretical frameworks, practical
                case studies, interactive exercises, and hands-on applications, you will gain valuable insights into the
                mindset and strategies required to navigate uncertainty, respond to short- and long-term challenges
                simultaneously, and leverage creativity as a catalyst for organizational transformation. You will also
                learn from successful companies like DeepMind, Intrinsic Robotics, NVIDIA, Patagonia, and Pixar that
                have translated long-term intent systematically and broadly across the organization to make consistent,
                compounding, short-term progress.
            </p>
            <hr>
            <!-- Week 1 Section -->
